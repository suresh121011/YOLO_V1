...
second opinion, HF transformers — ADR-P5-02). Registering a backend here is
...
from src.dataset.annotation.backends import cross_dataset, grounding_dino, yolo_world

__all__ = ["cross_dataset", "grounding_dino", "yolo_world"]
